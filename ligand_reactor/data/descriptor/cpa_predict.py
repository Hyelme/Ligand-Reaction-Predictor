...
new_model = tf.keras.models.load_model('C:\APM_Setup\htdocs\ligand_reactor\data\descriptor\P_action_cnn.h5')
#X[y,x,z] 형태
#print(X[0,:,:])
#print(X[1,:,0])
...
f=open('C:\APM_Setup\htdocs\ligand_reactor\data\predict\CPA_Plan.txt', mode='wt')
#y_pred =[]
